...
- `"prompt"` (the default): after a clean `create`, the feeder asks
  *"milestone-driver is installed: start building this milestone now, or review it first?"*
  Say yes to start the build; say no to stop and review.
