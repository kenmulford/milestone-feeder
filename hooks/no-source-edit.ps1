...
# fields below; see code.claude.com/docs/en/hooks.md):
...
# FEEDER_OWN_AGENTS: architect issue-author roadmap-splitter remediator
$FeederOwnAgents = @('architect', 'issue-author', 'roadmap-splitter', 'remediator')
