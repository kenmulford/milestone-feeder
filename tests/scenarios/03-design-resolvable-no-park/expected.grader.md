...
- Each design decision is recorded in the issue's Design section with a `Convention followed:` citation to the provided pattern. The decision is not invented from scratch and not parked.
